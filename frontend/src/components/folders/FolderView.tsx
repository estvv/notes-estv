...
import { exportFolderToPdf } from '../../utils/exportPdf';
...
export function FolderView() {
  ...
  const handleExportPdf = async () => {
    ...
    setIsExporting(true);
    try {
      await exportFolderToPdf(folder.name, notes);
    } catch (error) {
      ...
      <div className="border-b border-neutral-200 px-6 py-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`px-4 py-2 border border-neutral-200 rounded-lg font-medium transition-colors flex items-center gap-2 ${
            ...
            {isExporting ? (
              <>
                <svg className="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24">
                  ...
                  <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 3.373 0 8h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
                Exporting...
              </>
            ) : (
